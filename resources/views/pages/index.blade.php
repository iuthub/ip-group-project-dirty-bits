		...
		<form>
			<div class="form-row">
				<div class="col-md-4 mb-3">
					<input type="text" class="form-control" placeholder="Country, city, district, place...">
				</div>
				<div class="col-md-3 mb-3">
					<input type="date" class="form-control" value="2020-04-28">
				</div>
				<div class="col-md-3 mb-3">
					<input type="date" class="form-control" value="2020-04-29">
				</div>
